...
Review [Properly Installing Python](http://docs.python-guide.org/en/latest/starting/installation/) for help getting Python installed. The version of MkDocs required for working with LoopDocs works with Python 2.7, 3.3-3.6, and pypy.
