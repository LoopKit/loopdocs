...
* Blue light: Pump communications.  The blue light will flash periodically as it is communicating with the pump.  It's just letting you know that it is busy talking and collecting info.  You will see the blue light flash especially when you do a `Fetch History` command as that pulls a lot of information from the pump.
...
<p align="center">
<b>RileyLink with loose battery cable.</b>
</p> 
...
<p align="center">
<b>RileyLink with properly secured battery cable.</b>
</p> 
