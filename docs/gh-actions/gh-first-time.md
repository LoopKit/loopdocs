...
1. You did not complete [Add `App Group` to Other Identifiers](#add-app-group-to-identifiers) or one of the predecessor steps; review those steps
...
* Complete the [Add `App Group` to Other Identifiers](#add-app-group-to-identifiers)
