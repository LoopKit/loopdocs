...
![img/ns-core-events.png](img/ns-core-events.png){width="700"}
{align="center"}
...
![img/google1.png](img/google1.png){width="550"}
{align="center"}

* Click on the blue "New" button and create a new folder named IFTTT.

![img/google2.png](img/google2.png){width="550"}
{align="center"}
...
![img/google3.png](img/google3.png){width="550"}
{align="center"}
...
![img/google4.png](img/google4.png){width="550"}
{align="center"}
...
![img/webhooks2.png](img/webhooks2.png){width="550"}
{align="center"}
...
![img/webhooks3.png](img/webhooks3.png){width="550"}
{align="center"}

* Click on the blue "+that" text

![img/IFTTT_that2.png](img/IFTTT_that2.png){width="550"}
{align="center"}{width="550"}
{align="center"}

* Enter `google` in the search field and click on the Google Sheets icon

![img/webhooks4.png](img/webhooks4.png){width="550"}
{align="center"}{width="550"}
{align="center"}

* Select the green "Add row to spreadsheet" box

![img/webhooks5.png](img/webhooks5.png){width="550"}
{align="center"}
...
![img/webhooks8.png](img/webhooks8.png){width="550"}
{align="center"}
...
![img/webhooks9.png](img/webhooks9.png){width="550"}
{align="center"}

********

![img/webhooks10.png](img/webhooks10.png){width="550"}
{align="center"}

* You will see your Maker Key as the last part of the URL; copy that last part (the red circled part)

![img/webhooks11.png](img/webhooks11.png){width="550"}
{align="center"}
...
![img/IFTTT_NSkey.png](img/IFTTT_NSkey.png){width="550"}
{align="center"}

![img/IFTTT_enable.png](img/IFTTT_enable.png){width="550"}
{align="center"}
...
![img/webhooks12.png](img/webhooks12.png){width="550"}
{align="center"}
...
![img/webhooks13.png](img/webhooks13.png){width="550"}
{align="center"}
...
![img/webhooks15.png](img/webhooks15.png){width="550"}
{align="center"}

* Select the "Send a Pushover notification" box

![img/webhooks16.png](img/webhooks16.png){width="550"}
{align="center"}
...
![img/webhooks17.png](img/webhooks17.png){width="550"}
{align="center"}

* Select the "Message Priority" that you would like for this particular alarm type.

![img/webhooks18.png](img/webhooks18.png){width="550"}
{align="center"}
...
![img/webhooks19.png](img/webhooks19.png){width="550"}
{align="center"}
...
![img/webhooks20.png](img/webhooks20.png){width="550"}
{align="center"}
...
![img/webhooks23.png](img/webhooks23.png){width="550"}
{align="center"}

* Here are examples of the Meal Bolus and Temp Basal ns-event logging spreadsheets

![img/webhooks21.png](img/webhooks21.png){width="550"}
{align="center"}

![img/webhooks22.png](img/webhooks22.png){width="550"}
{align="center"}
