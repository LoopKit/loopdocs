...
This page combines parts of an earlier version of Step 13: Download Loop and Step 14: Build Loop App - it is kept for reference as the docs move from the zip download build method to the new Workspace method.

## From Zip Download Version of Step 13:

The zip download and build method is deprecated, but if you want to use it, click on the link below to download the latest version. Read the extra information you need until such time as the Cartfile.resolved gets updated:
...
!!! warning "Xcode 13 requires Workspace Build"

    With the advent of Xcode 13, the old zip method can no longer be used.

## Archived version of Step 14:
