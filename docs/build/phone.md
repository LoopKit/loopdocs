...
!!! warning "iPhone 16 and Omnipod DASH"
    At the current time, DASH pods produced in 2025 and later have different chips and firmware than were used for earlier manufacturing dates. 
    ...
    * No solution to this issue is known (yet)
    ...
    > The older pods advertise with a Bluetooth Device name of `TWI Board` and are fully compatible with all phones listed below.
